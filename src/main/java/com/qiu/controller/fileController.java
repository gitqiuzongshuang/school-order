...
public class fileController {
	...
	static public String savePath ="http://localhost:8080/dataResourceImages/";
	static public String docPath ="E:/images";
    static public String uploadFile(String baseUrl, MultipartFile file) throws IllegalStateException, IOException {
       ...
       /* Client client = new Client();
        ...
        File newFile = new File(docPath + File.separator + File.separator + fileName);
        file.transferTo(newFile);
        fileName = fileName.insert(0, savePath + '/');
...
//        webresource.get(serverPicUrl + url);
    ...
    static public boolean save(File file, String filename, String savepath) {
